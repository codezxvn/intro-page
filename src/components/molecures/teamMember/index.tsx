...
export default function TeamMember(props: TeamMemberProps) {
  ...
  return (
    <div
      className={`sm:w-1/3 lg:w-full lg:aspect-[5/7] aspect-square relative bg-p mb-8 drop-shadow-lg lg:hover:-translate-y-4 lg:hover:scale-125 lg:hover:z-20 lg:last-of-type:hover:-translate-x-[10%] lg:first-of-type:hover:translate-x-[10%] cursor-pointer`}
